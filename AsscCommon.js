...
var locationPort = window.location.host;
let ordHttpDomain;

if (locationPort.length > 0)
{
	ordHttpDomain = "http://www.akmall.com:"+locationPort;
} else {
...
function loginPop(goUrl,area_code){
    ...
    openWindowPopup(ordHttpDomain + '/login/pLogin.do?goUrl='+goUrl+'', 'loginPop', 442, 706, 'center');
